...
function inicializaJogo() {
  ...
  this.imgsCartasPre = [
    ['images/menor que.png', 'images/menor queOK.gif'],
    ['images/maior que.png', 'images/maior queOK.gif'],
    ['images/mais.png', 'images/maisOK.gif'],
    ['images/menos.png', 'images/menosOK.gif'],
    ['images/igual.png', 'images/igualOK.gif'],
    ['images/pertence.png', 'images/pertenceOK.gif'],
    ['images/nao pertence.png', 'images/nao pertenceOK.gif'],
    ['images/porcentagem.png', 'images/porcentagemOK.gif'],
    ['images/multiplicacao.png', 'images/multiplicacaoOK.gif'],
    ['images/divisao.png', 'images/divisaoOK.gif']
  ];
...
function trocaValorCarta(idClicado) {
  ...
  if (document.getElementById(idClicado).src == window.imgsCartas[idClicado]) {
    ...
    if (window.valorAtual == window.pares[idClicado] && idClicado != idAnt) {
      setTimeout(function() {
        document.getElementById(idClicado).setAttribute('style', 'opacity: 0;'); // deixa o cartão transparente
        document.getElementById(idClicado).onclick = null; // remove o evento de click
        document.getElementById(idAnt).setAttribute('style', 'opacity: 0;');
        document.getElementById(idAnt).onclick = null;
        ...
        console.log(achou);
        if (!achou) {
          document.getElementById('div_vitoria_memoria').style.display =
            'block';
        }
